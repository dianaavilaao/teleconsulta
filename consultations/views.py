...
# (si tiene texto, cuenta 1). Se valida en confirm_symptoms (fuente de
# verdad) y se expone a waiting_room.html para que el frontend no lo
# duplique como número mágico.
MAX_SYMPTOMS = 5
